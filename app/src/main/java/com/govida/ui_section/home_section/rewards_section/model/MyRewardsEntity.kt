...
class MyRewardsEntity {
    ...
    @SerializedName("balanceGovidaPoints")
    @Expose
    @ColumnInfo(name = "balanceGovidaPoints")
    var balanceGovidaPoints: Int? = null

    @SerializedName("employeeRewardId")
    @Expose
    @ColumnInfo(name = "employeeRewardId")
    var employeeRewardId: Int? = null
